        ...
        <table class="table table-bordered" id="table-data">
            ...
            ?>
                <tr>
                    ...
                    <td class="action">
                        <!-- <a href="invoiceprint.php?RoomID= <?php echo $res['RoomID']?>"><button class="btn btn-primary"><i class="fa-solid fa-print"></i>Print</button></a> -->
						<a href="paymantdelete.php?RoomID=<?php echo $res['RoomID']?>"><button class="btn btn-danger">Delete</button></a>
                    </td>
                </tr>
            <?php
            }
